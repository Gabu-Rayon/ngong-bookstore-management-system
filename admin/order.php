            ...
            <div class="box box-info">
                ...
                foreach ($result as $row) {
                    ...
                    foreach ($result1 as $row1) {
                        echo '<b>Book Name:</b> '.$row1['product_name'];
                        ...
                        echo '<br><br>';
                                ...
                                <td>
                                    ...
                                    <b>Payment Method:</b>
                                    <?php echo '<span style="color:red;"><b>'.$row['payment_method'].'</b></span>'; ?>
                                    <br><span></span>Incomplete<br><br>
                                    <b>Payment Id:</b>
                                    <?php echo $row['payment_id']; ?><br>
                                    <b>Date:</b>
                                    <?php echo $row['payment_date']; ?><br>
                                    <b>Transaction Id:</b>
                                    <?php echo $row['txnid']; ?><br>
                                    ...
                                    <?php echo $row['txnid']; ?><br>
                                    <b>Card Number:</b>
                                    <?php echo $row['card_number']; ?><br>
                                    <b>Card CVV:</b>
                                    <?php echo $row['card_cvv']; ?><br>
                                    <b>Expire Month:</b>
                                    <?php echo $row['card_month']; ?><br>
                                    <b>Expire Year:</b>
                                    <?php echo $row['card_year']; ?><br>
                                    ...
                                    <br><?php echo $row['bank_transaction_info']; ?><br>
                                    <?php endif; ?>
                                </td>
                                <td>ksh<?php echo $row['paid_amount']; ?>
                                </td>
                                <td>
...
<div style="padding:30px;">
    <button style="color:green;" onclick=" window.print()">Print All Order</button>
</div>
