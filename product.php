                        ...
                        <div class="col-md-7">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="p-price">
                                    ...
                                    <span>
                                        <?php if($p_old_price!=''): ?>
                                        <del><?php echo 'ksh'; ?><?php echo $p_old_price; ?></del>
                                        <?php endif; ?>
                                        <?php echo 'ksh'; ?><?php echo $p_current_price; ?>
                                    </span>
                                </div>
...
<div class="product bg-gray pt_70 pb_70">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="headline">
                    <h2><?php echo 'RELATED BOOKS'; ?></h2>
                    <h3><?php echo 'See all the related books from below'; ?></h3>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="product-carousel">
                    ...
                    <div class="item">
                        ...
                        <div class="text">
                            ...
                            <h4>
                                <?php echo 'ksh'; ?><?php echo $row['p_current_price']; ?>
                                <?php if($row['p_old_price'] != ''): ?>
                                <del>
                                    <?php echo 'ksh'; ?><?php echo $row['p_old_price']; ?>
                                </del>
                                <?php endif; ?>
                            </h4>
                            <div class="rating">
